...
/**
 * Commit Log Manager (pg_xact equivalent).
 *
 ...
 */
public final class ClogManager implements AutoCloseable {
    ...
    // File format
    private static final int FILE_MAGIC = 0x58414354; // "XACT"
    ...
    private ClogManager(Path filePath, FileChannel channel, byte[] xactCache) {
     ...
     */
    public static ClogManager create(Path dataDir) throws IOException {
        ...
        return new ClogManager(filePath, channel, cache);
    }
     ...
     */
    public static ClogManager open(Path dataDir) throws IOException {
    ...
    public synchronized Stats getStats() {
        ...
        return new Stats(entryCount(), inProgress, committed, aborted, xactCache.length);
    }
